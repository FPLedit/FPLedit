...
namespace FPLedit.Shared.Tests
{
    public class TimeEntryTests
    {
        ...
        public void InitTest()
        {
            ...
            Assert.AreEqual(-9, timeEntry.Hours);
            Assert.AreEqual(0, timeEntry.Minutes);
            Assert.AreEqual(-540, timeEntry.GetMinutes());
        }
