...
#pragma warning restore CS0067
    ...
    public int AddRoute(Station exisitingStartStation, Station newStation, decimal newStartPosition, decimal newPosition) => throw new NotSupportedException(ThrowMessage);
    public bool JoinRoutes(int route, Station station, decimal newKm) => throw new NotSupportedException(ThrowMessage);
