...
namespace FPLedit.Shared.DefaultImplementations
{
    public sealed class BasicPreview : IPreviewProxy
    {
        ...
        public void Show(IPluginInterface pluginInterface)
        {
            ...
            bool success = export.SafeExport(pluginInterface.Timetable, path, pluginInterface, tryoutConsole ? new [] { BasicTemplateExport.FLAG_TYROUT_CONSOLE } : Array.Empty<string>());
