...
#pragma warning restore CS0649
        ...
        public ShuntForm(ITrain train, ArrDep arrDep, Station sta)
        {
            ...
            gridView.AddColumn<ShuntMove, TimeEntry>(s => s.Time, ts => ts.ToShortTimeString(), s => { train.ParentTimetable.TimeFactory.TryParse(s, out var res); return res; }, T._("Zeit"), editable: true);
